...
<td><img src="<?php echo $menu2; ?> " height=90px width=90px  alt=menu2/></td>
<td><img src="<?php echo base_url('images/cat1.jpg'); ?> " height=90px width=90px  alt=menu2/></td>
</tr>
</table>
</center>
 </div>
...
<img src="http://127.0.0.1/citest/application/views/shops/<?php echo $shopfile.''.$menu1; ?> " style=" width:60% ; height:50%"/>\
